...
4. **Make your changes**: Add your code changes and commit them with clear and descriptive messages.
5. **Run tests and checks**: Run `make test` and `make check`, and ensure all tests and checks are passing.
6. **Submit a Pull Request**: Once your changes are ready, submit a pull request to the main repository. Provide a clear description of the changes you made and reference any related issues.
